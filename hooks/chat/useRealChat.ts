...
export const useRealChat = (
    ...
    const [sendMessageMutation] = useMutation(SEND_MESSAGE, {
        onError: (error) => {
            console.error("[BUYER] 💥 Apollo mutation error:", error);
            console.error("[BUYER] 💥 Error message:", error.message);
            console.error("[BUYER] 💥 GraphQL errors:", error.graphQLErrors);
            console.error("[BUYER] 💥 Network error:", error.networkError);
            console.error("[BUYER] 💥 Extra info:", error.extraInfo);
        },
    ...
    const handleSend = useCallback(
        async (text: string, files: File[] = []) => {
            ...
            try {
                ...
                console.log('[BUYER] 📬 Received mutation response:', data);

                if (data?.sendMessage) {
                    console.log('[BUYER] ✅ Message sent successfully:', data.sendMessage);
                    ...
                    console.error('[BUYER] ❌ No sendMessage in response. Full data:', data);
