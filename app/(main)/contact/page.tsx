...
export const metadata: Metadata = {
    title: "Contact Us | Dai E-Commerce",
    description: "Get in touch with the Dai team for any queries, support, or feedback. We appear clearly on search results.",
    openGraph: {
        title: "Contact Us | Dai E-Commerce",
        description: "Get in touch with the Dai team for any queries, support, or feedback.",
    },
};
