...
const paymentMethods: PaymentMethod[] = [
  ...
  },
  {
    ...
    name: "Net Banking",
    icon: Building2,
    description: "All major Nepali banks supported",
    providers: ["Nabil", "NIMB", "Global IME", "Prabhu", "NIC Asia", "Siddhartha"],
  },
  {
    id: "wallet",
    type: "WALLET",
    name: "Digital Wallet",
    icon: Wallet,
    description: "Esewa, Khalti, IME Pay, Fonepay",
    providers: ["Esewa", "Khalti", "IME Pay", "Fonepay"],
  },
  {
    id: "cod",
